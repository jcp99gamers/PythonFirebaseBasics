...
FilePath = "C:\\Users\\mahes\\OneDrive\\Desktop\\Cloud\\Cloud\\jcp99gamer\\serviceAccountKey.json"
import os
...
print("\nDetails of the Student with PRN"+PRN+" = ")
print(detailsOFstudent)
print("\n")
#Create
...
#Delete
collectionStudents.document('20030121066').delete() #Delete Document
collectionStudents.document('20030121055').update({'Holla': firestore.DELETE_FIELD}) #Delete Field